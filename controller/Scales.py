...
class Scale:
    def __init__(self, key, scale_mode):
        '''Params key of the scale. Scale_mode : Major or Minor. '''
        self._i = 0
        self._ii = 0
        self._iii = 0
        self._iv = 0
        ...
        self._proc_scale(unprocessedScale, scale_mode)
    ...
    def _proc_scale(self, scale, scale_mode):
        C05 = CircleOfFifths.CircleOfFifth(scale, scale_mode)
